    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'reportDetails',
          visible: true,
          scopedSlots: { customRender: 'reportDetails' },
          sorter: true
          //sorter: (a, b) => a.reportDetails - b.reportDetails,
          //sorter: (a, b) => a.reportDetails.localeCompare(b.reportDetails),
        },
        {
          title: 'Date Reported',
		dataIndex: 'dateReported',
          visible: true,
          scopedSlots: { customRender: 'dateReported' },
          sorter: true
          //sorter: (a, b) => a.dateReported - b.dateReported,
          //sorter: (a, b) => a.dateReported.localeCompare(b.dateReported),
        },
      ],
      pagination: {
        current: 1,
